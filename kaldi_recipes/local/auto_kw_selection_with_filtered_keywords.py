...
def main():
    ...
    train_w_count, _ = get_kw_and_word_count(os.path.join(data_dir, "train/text"), keywords)
    dev_w_count, _ = get_kw_and_word_count(os.path.join(data_dir, "dev/text"), keywords)
    test_w_count, _ = get_kw_and_word_count(os.path.join(data_dir, "test/text"), keywords)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-num_kw", type=int, default=600, help="desired number of keywords")
